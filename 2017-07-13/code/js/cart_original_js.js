  ...
  function getTotal(){
    ...
    for (var i = 0; i < tr.length; i++) {
      ...
      if(tr[i].getElementsByTagName('input')[0].checked){
        ...
        HTMLstr+='<div class="selectedViewBlock"><img src="'+tr[i].getElementsByTagName('img')[0].src+'"/><span class="selCount">'+perCount+'</span><span class="del" index="'+i+'">取消选择</span></div>'
      }else{
        tr[i].className=" ";
      }
    };
